      ...
      <div className="flex-1 flex items-center justify-center p-8 transition-colors duration-200" style={{ background: 'var(--bg-card)' }}>
        <div className="w-full max-w-md">
          <div className="text-center mb-8">
            ...
            <p className="text-sm mt-1" style={{ color: 'var(--text-muted)' }}>Sign in to access your analytics dashboard</p>
          </div>
          ...
          <p className="text-center text-xs mt-6" style={{ color: 'var(--text-faint)' }}>
            Demo: <span style={{ color: '#60a5fa' }}>admin / admin123</span>
          </p>
          <p className="text-center text-sm mt-3" style={{ color: 'var(--text-muted)' }}>
            Don't have an account?{' '}
            <Link to="/register" className="font-medium hover:underline" style={{ color: '#60a5fa' }}>
              Create one
            </Link>
          </p>
        </div>
